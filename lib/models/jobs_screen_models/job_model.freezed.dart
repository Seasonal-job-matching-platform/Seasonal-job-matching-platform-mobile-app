...
@JsonKey(fromJson: _forceString) String get title;@JsonKey(fromJson: _forceString) String get description;@JsonKey(fromJson: _forceInt) int get id;@JsonKey(fromJson: _forceString) String get type;@JsonKey(fromJson: _forceString) String get location;@JsonKey(fromJson: _forceString) String get startDate;@JsonKey(fromJson: _forceDouble) double get amount;@JsonKey(fromJson: _forceStringNullable) String? get currency;@JsonKey(fromJson: _forceString) String get salary;@JsonKey(fromJson: _forceStringNullable) String? get duration;@JsonKey(fromJson: _forceString) String get status;@JsonKey(fromJson: _forceInt) int get numOfPositions;@JsonKey(fromJson: _forceStringNullable) String? get workArrangement;@JsonKey(fromJson: _forceInt) int get jobposterId;@JsonKey(fromJson: _forceString) String get jobposterName;@JsonKey(fromJson: _forceStringNullable) String? get createdAt; List<String> get requirements; List<String> get categories; List<String> get benefits; List<JobComment> get comments;
...
@useResult
$Res call({
@JsonKey(fromJson: _forceString) String title,@JsonKey(fromJson: _forceString) String description,@JsonKey(fromJson: _forceInt) int id,@JsonKey(fromJson: _forceString) String type,@JsonKey(fromJson: _forceString) String location,@JsonKey(fromJson: _forceString) String startDate,@JsonKey(fromJson: _forceDouble) double amount,@JsonKey(fromJson: _forceStringNullable) String? currency,@JsonKey(fromJson: _forceString) String salary,@JsonKey(fromJson: _forceStringNullable) String? duration,@JsonKey(fromJson: _forceString) String status,@JsonKey(fromJson: _forceInt) int numOfPositions,@JsonKey(fromJson: _forceStringNullable) String? workArrangement,@JsonKey(fromJson: _forceInt) int jobposterId,@JsonKey(fromJson: _forceString) String jobposterName,@JsonKey(fromJson: _forceStringNullable) String? createdAt, List<String> requirements, List<String> categories, List<String> benefits, List<JobComment> comments
});
...
class _JobModel implements JobModel {
  const _JobModel({@JsonKey(fromJson: _forceString) required this.title, @JsonKey(fromJson: _forceString) required this.description, @JsonKey(fromJson: _forceInt) required this.id, @JsonKey(fromJson: _forceString) required this.type, @JsonKey(fromJson: _forceString) required this.location, @JsonKey(fromJson: _forceString) required this.startDate, @JsonKey(fromJson: _forceDouble) required this.amount, @JsonKey(fromJson: _forceStringNullable) this.currency, @JsonKey(fromJson: _forceString) required this.salary, @JsonKey(fromJson: _forceStringNullable) this.duration, @JsonKey(fromJson: _forceString) required this.status, @JsonKey(fromJson: _forceInt) required this.numOfPositions, @JsonKey(fromJson: _forceStringNullable) this.workArrangement, @JsonKey(fromJson: _forceInt) required this.jobposterId, @JsonKey(fromJson: _forceString) required this.jobposterName, @JsonKey(fromJson: _forceStringNullable) this.createdAt, final  List<String> requirements = const [], final  List<String> categories = const [], final  List<String> benefits = const [], final  List<JobComment> comments = const []}): _requirements = requirements,_categories = categories,_benefits = benefits,_comments = comments;
...
@override@JsonKey(fromJson: _forceStringNullable) final  String? currency;
