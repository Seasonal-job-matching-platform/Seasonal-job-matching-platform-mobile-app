...
' complete with slide transition effects and progressive reveals.
'
...
Sub GenerateDefenseSlides()
    ...
    ' Flowchart Connectors (for animation tracking)
    Dim arrow1 As Shape
    Dim arrow2 As Shape
    Dim arrow3 As Shape
    
    ' Textboxes (assigned to animate text sequentially)
    Dim gBody As Shape
    Dim sBody As Shape
    Dim scopeBody As Shape
    Dim archDetails As Shape
    Dim navDetails As Shape
    Dim secBody As Shape
    Dim perfBody1 As Shape
    Dim perfBody2 As Shape
    Dim updateBody As Shape
    Dim feedBody As Shape
    Dim benchDetails As Shape
    Dim testBody As Shape
    Dim roadBody As Shape
    ...
    ' Credentials
    Set roadBody = sld.Shapes.AddTextbox(msoOrientationHorizontal, 50, 380, 860, 80)
    With roadBody.TextFrame.TextRange
    ...
    ' Animations Slide 1
    AddFadeIn sld, titleShape, msoAnimTriggerAfterPrevious
    AddFadeIn sld, bodyShape, msoAnimTriggerAfterPrevious
    AddFadeIn sld, roadBody, msoAnimTriggerAfterPrevious
    ...
    Set gBody = sld.Shapes.AddTextbox(msoOrientationHorizontal, 60, 120, 390, 340)
    With gBody.TextFrame.TextRange
    ...
    Set sBody = sld.Shapes.AddTextbox(msoOrientationHorizontal, 510, 120, 390, 340)
    With sBody.TextFrame.TextRange
    ...
    ' Animations Slide 2
    AddFadeIn sld, titleShape, msoAnimTriggerAfterPrevious
    AddFadeIn sld, gBox, msoAnimTriggerAfterPrevious
    AddFadeIn sld, gBody, msoAnimTriggerWithPrevious
    AddFadeIn sld, sBox, msoAnimTriggerOnPageClick
    AddFadeIn sld, sBody, msoAnimTriggerWithPrevious
    ...
    Set scopeBody = sld.Shapes.AddTextbox(msoOrientationHorizontal, 50, 110, 410, 360)
    With scopeBody.TextFrame.TextRange
    ...
    ' Animations Slide 3
    AddFadeIn sld, titleShape, msoAnimTriggerAfterPrevious
    AddFadeIn sld, scopeBody, msoAnimTriggerAfterPrevious
    AddFadeIn sld, gPanel, msoAnimTriggerOnPageClick
    AddFadeIn sld, bodyShape, msoAnimTriggerWithPrevious
    AddFadeIn sld, sClient, msoAnimTriggerAfterPrevious
    AddFadeIn sld, sArrow, msoAnimTriggerAfterPrevious
    AddFadeIn sld, sBackend, msoAnimTriggerAfterPrevious
    ...
    ' Draw Stacked Layers
    ' Pres Layer
    Set shp1 = sld.Shapes.AddShape(msoShapeRoundedRectangle, 100, 110, 760, 80)
    shp1.Fill.Solid
    shp1.Fill.ForeColor.RGB = RGB(30, 70, 140)
    shp1.TextFrame.TextRange.Text = "Presentation Layer (Widgets / View Shells / Riverpod Providers)"
    shp1.TextFrame.TextRange.Font.Color.RGB = cWhite
    shp1.TextFrame.TextRange.Font.Size = 18
    shp1.TextFrame.TextRange.Font.Bold = msoTrue
    
    ' Domain Layer
    Set shp2 = sld.Shapes.AddShape(msoShapeRoundedRectangle, 100, 210, 760, 80)
    shp2.Fill.Solid
    shp2.Fill.ForeColor.RGB = RGB(60, 100, 170)
    shp2.TextFrame.TextRange.Text = "Domain Layer (Pure UseCases / Business Validations)"
    shp2.TextFrame.TextRange.Font.Color.RGB = cWhite
    shp2.TextFrame.TextRange.Font.Size = 18
    shp2.TextFrame.TextRange.Font.Bold = msoTrue
    
    ' Data Layer
    Set shp3 = sld.Shapes.AddShape(msoShapeRoundedRectangle, 100, 310, 760, 80)
    shp3.Fill.Solid
    shp3.Fill.ForeColor.RGB = RGB(90, 130, 200)
    shp3.TextFrame.TextRange.Text = "Data Layer (Repositories / Local Secure Storage / API Dio wrappers)"
    shp3.TextFrame.TextRange.Font.Color.RGB = cWhite
    shp3.TextFrame.TextRange.Font.Size = 18
    shp3.TextFrame.TextRange.Font.Bold = msoTrue
    
    ' Details Below Stack
    Set archDetails = sld.Shapes.AddTextbox(msoOrientationHorizontal, 100, 410, 760, 80)
    With archDetails.TextFrame.TextRange
    ...
    ' Animations Slide 4
    AddFadeIn sld, titleShape, msoAnimTriggerAfterPrevious
    AddFadeIn sld, shp1, msoAnimTriggerOnPageClick
    AddFadeIn sld, shp2, msoAnimTriggerAfterPrevious
    AddFadeIn sld, shp3, msoAnimTriggerAfterPrevious
    AddFadeIn sld, archDetails, msoAnimTriggerAfterPrevious
    ...
    ' Draw Connections
    Set arrow1 = sld.Shapes.AddShape(msoShapeDownArrow, 470, 175, 20, 20)
    arrow1.Line.Visible = msoFalse
    arrow1.Fill.Solid
    arrow1.Fill.ForeColor.RGB = cText
    
    Set arrow2 = sld.Shapes.AddShape(msoShapeLeftArrow, 290, 240, 80, 20)
    arrow2.Line.Visible = msoFalse
    arrow2.Fill.Solid
    arrow2.Fill.ForeColor.RGB = cText
    
    Set arrow3 = sld.Shapes.AddShape(msoShapeDownArrow, 470, 305, 20, 30)
    arrow3.Line.Visible = msoFalse
    arrow3.Fill.Solid
    arrow3.Fill.ForeColor.RGB = cText
    
    ' Annotations
    Dim tag1 As Shape
    Set tag1 = sld.Shapes.AddTextbox(msoOrientationHorizontal, 300, 210, 80, 30)
    tag1.TextFrame.TextRange.Text = "Mandatory"
    tag1.TextFrame.TextRange.Font.Size = 10
    
    Dim tag2 As Shape
    Set tag2 = sld.Shapes.AddTextbox(msoOrientationHorizontal, 490, 310, 100, 30)
    tag2.TextFrame.TextRange.Text = "Optional / None"
    tag2.TextFrame.TextRange.Font.Size = 10
    
    ' Details Below Diagram
    Set navDetails = sld.Shapes.AddTextbox(msoOrientationHorizontal, 100, 420, 760, 80)
    With navDetails.TextFrame.TextRange
    ...
    ' Animations Slide 5
    AddFadeIn sld, titleShape, msoAnimTriggerAfterPrevious
    AddFadeIn sld, bSplash, msoAnimTriggerOnPageClick
    AddFadeIn sld, arrow1, msoAnimTriggerAfterPrevious
    AddFadeIn sld, bVerCheck, msoAnimTriggerAfterPrevious
    AddFadeIn sld, arrow2, msoAnimTriggerOnPageClick
    AddFadeIn sld, tag1, msoAnimTriggerWithPrevious
    AddFadeIn sld, bBlocker, msoAnimTriggerAfterPrevious
    AddFadeIn sld, arrow3, msoAnimTriggerOnPageClick
    AddFadeIn sld, tag2, msoAnimTriggerWithPrevious
    AddFadeIn sld, bShell, msoAnimTriggerAfterPrevious
    AddFadeIn sld, navDetails, msoAnimTriggerAfterPrevious
    ...
    Set secBody = sld.Shapes.AddTextbox(msoOrientationHorizontal, 520, 110, 390, 360)
    With secBody.TextFrame.TextRange
    ...
    ' Animations Slide 6
    AddFadeIn sld, titleShape, msoAnimTriggerAfterPrevious
    AddFadeIn sld, codePanel, msoAnimTriggerOnPageClick
    AddFadeIn sld, bodyShape, msoAnimTriggerWithPrevious
    AddFadeIn sld, secBody, msoAnimTriggerOnPageClick
    ...
    Set perfBody1 = sld.Shapes.AddTextbox(msoOrientationHorizontal, 60, 120, 390, 340)
    With perfBody1.TextFrame.TextRange
    ...
    Set perfBody2 = sld.Shapes.AddTextbox(msoOrientationHorizontal, 510, 120, 390, 340)
    With perfBody2.TextFrame.TextRange
    ...
    ' Animations Slide 7
    AddFadeIn sld, titleShape, msoAnimTriggerAfterPrevious
    AddFadeIn sld, col1, msoAnimTriggerOnPageClick
    AddFadeIn sld, perfBody1, msoAnimTriggerWithPrevious
    AddFadeIn sld, col2, msoAnimTriggerOnPageClick
    AddFadeIn sld, perfBody2, msoAnimTriggerWithPrevious
    ...
    Set updateBody = sld.Shapes.AddTextbox(msoOrientationHorizontal, 50, 110, 410, 360)
    With updateBody.TextFrame.TextRange
    ...
    ' Draw Connections
    Set arrow1 = sld.Shapes.AddShape(msoShapeDownArrow, 695, 195, 20, 30)
    arrow1.Line.Visible = msoFalse
    arrow1.Fill.Solid
    arrow1.Fill.ForeColor.RGB = cText
    
    Set arrow2 = sld.Shapes.AddShape(msoShapeDownArrow, 695, 315, 20, 40)
    arrow2.Line.Visible = msoFalse
    arrow2.Fill.Solid
    arrow2.Fill.ForeColor.RGB = cText
    
    Dim nodeDetails As Shape
    Set nodeDetails = sld.Shapes.AddTextbox(msoOrientationHorizontal, 715, 320, 80, 30)
    nodeDetails.TextFrame.TextRange.Text = "No / Expired"
    nodeDetails.TextFrame.TextRange.Font.Size = 9
    
    ' Animations Slide 8
    AddFadeIn sld, titleShape, msoAnimTriggerAfterPrevious
    AddFadeIn sld, updateBody, msoAnimTriggerAfterPrevious
    AddFadeIn sld, updatePanel, msoAnimTriggerOnPageClick
    AddFadeIn sld, node1, msoAnimTriggerAfterPrevious
    AddFadeIn sld, arrow1, msoAnimTriggerAfterPrevious
    AddFadeIn sld, node2, msoAnimTriggerAfterPrevious
    AddFadeIn sld, arrow2, msoAnimTriggerAfterPrevious
    AddFadeIn sld, nodeDetails, msoAnimTriggerWithPrevious
    AddFadeIn sld, node3, msoAnimTriggerAfterPrevious
    ...
    Set feedBody = sld.Shapes.AddTextbox(msoOrientationHorizontal, 50, 110, 410, 360)
    With feedBody.TextFrame.TextRange
    ...
    ' Animations Slide 9
    AddFadeIn sld, titleShape, msoAnimTriggerAfterPrevious
    AddFadeIn sld, feedBody, msoAnimTriggerAfterPrevious
    AddFadeIn sld, pBox, msoAnimTriggerOnPageClick
    AddFadeIn sld, bodyShape, msoAnimTriggerWithPrevious
    ...
    ' Note Below Tables
    Set benchDetails = sld.Shapes.AddTextbox(msoOrientationHorizontal, 50, 430, 860, 40)
    With benchDetails.TextFrame.TextRange
    ...
    ' Animations Slide 10
    AddFadeIn sld, titleShape, msoAnimTriggerAfterPrevious
    AddFadeIn sld, t1, msoAnimTriggerOnPageClick
    AddFadeIn sld, t2, msoAnimTriggerOnPageClick
    AddFadeIn sld, benchDetails, msoAnimTriggerAfterPrevious
    ...
    ' Left box: Testing
    Set testBody = sld.Shapes.AddTextbox(msoOrientationHorizontal, 50, 110, 410, 360)
    With testBody.TextFrame.TextRange
    ...
    ' Animations Slide 11
    AddFadeIn sld, titleShape, msoAnimTriggerAfterPrevious
    AddFadeIn sld, testBody, msoAnimTriggerAfterPrevious
    AddFadeIn sld, tMatrix, msoAnimTriggerOnPageClick
    ...
    ' Left box: Summary
    Set roadBody = sld.Shapes.AddTextbox(msoOrientationHorizontal, 50, 110, 410, 360)
    With roadBody.TextFrame.TextRange
    ...
    ' Draw simple lines
    Set arrow1 = sld.Shapes.AddShape(msoShapeDownArrow, 695, 205, 20, 30)
    arrow1.Line.Visible = msoFalse
    arrow1.Fill.Solid
    arrow1.Fill.ForeColor.RGB = cText
    
    Set arrow2 = sld.Shapes.AddShape(msoShapeDownArrow, 695, 305, 20, 30)
    arrow2.Line.Visible = msoFalse
    arrow2.Fill.Solid
    arrow2.Fill.ForeColor.RGB = cText
    ...
    AddFadeIn sld, titleShape, msoAnimTriggerAfterPrevious
    AddFadeIn sld, roadBody, msoAnimTriggerAfterPrevious
    AddFadeIn sld, timelineBox, msoAnimTriggerOnPageClick
    AddFadeIn sld, tVal1, msoAnimTriggerAfterPrevious
    AddFadeIn sld, arrow1, msoAnimTriggerAfterPrevious
    AddFadeIn sld, tVal2, msoAnimTriggerAfterPrevious
    AddFadeIn sld, arrow2, msoAnimTriggerAfterPrevious
    AddFadeIn sld, tVal3, msoAnimTriggerAfterPrevious
    
    ' Closing
    MsgBox "Presentation Slides and Animations Created Successfully!", vbInformation, "VBA Generator"
End Sub

' =========================================================================
' HELPER SUBROUTINE: Apply Fade In Effect
' =========================================================================
Private Sub AddFadeIn(ByRef sld As Slide, ByRef shp As Shape, ByVal triggerType As Integer)
    On Error Resume Next
    ' msoAnimEffectFade = 10
    sld.TimeLine.MainSequence.AddEffect Shape:=shp, effectId:=10, Trigger:=triggerType
    On Error GoTo 0
End Sub
