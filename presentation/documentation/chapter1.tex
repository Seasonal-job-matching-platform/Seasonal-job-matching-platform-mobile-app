...
\textbf{OBJ-UPD-1} & Automated Update Deployment & Query GitHub Releases on startup to identify mandatory versions, blocking user navigation during critical patches. \\ \hline
\textbf{OBJ-CURR-1} & Multi-Currency Localization & Dynamically reload listings and reformat salaries utilizing platform-localized currency parameters. \\ \hline
\textbf{OBJ-FDBK-1} & In-App Issue Feedback & Provide custom reporting routes supporting email inclusion or anonymous client submissions. \\ \hline
\end{tabular}
\end{table}
